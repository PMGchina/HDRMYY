...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/web/front-doctor.css">
	</head>
	<body>
		<div class="container-fluid">
			<div class="page-header my-panel-warning text-center"><span>专 家 名 录</span></div>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/web/front-doctor-biz.js"></script>
	</body>
</html>
