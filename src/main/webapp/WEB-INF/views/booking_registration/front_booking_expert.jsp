...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/web/front-booking-expert.css">
	</head>
	<body>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/web/front-booking-expert-biz.js"></script>
			...
			<div class="modal-dialog" id="doctorDialog">
				<div class="modal-content">
					<div class="modal-header my-panel-warning text-center">
						...
						<span class="glyphicon glyphicon-user modal-header-icon"></span>
						<h3 class="modal-header-title" id="doctorModalLabel">预 约 主 任</h3>
					</div>
					<div class="modal-body">
					</div>
					<div class="modal-footer">
