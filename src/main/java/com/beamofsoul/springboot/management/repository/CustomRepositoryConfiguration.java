...
import static com.beamofsoul.springboot.management.util.ConfigurationReader.*;
...
public class CustomRepositoryConfiguration {
	...
	private static final String DEFAULT_FACTORY_PATH 
		= "com.beamofsoul.springboot.management.repository.BaseMultielementRepositoryFactory";
