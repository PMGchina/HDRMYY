...
import static com.beamofsoul.springboot.management.util.AnnotationRepositoryNameMapping.repositoryMap;
...
import com.beamofsoul.springboot.management.repository.BaseMultielementRepositoryFactory;
...
import com.beamofsoul.springboot.management.util.SpringUtils;
	...
	public Object doAround(ProceedingJoinPoint joinPoint, CacheableBasedPageableCollection cacheableBasedPageableCollection) {
		...
		try {
			...
			BaseMultielementRepository<?, Long> reps = repositoryMap.containsKey(entityName) ?
					...
					(BaseMultielementRepository<?, Long>) baseMultielementRepositoryFactory.init(entityClass, entityManager).doInstance();
