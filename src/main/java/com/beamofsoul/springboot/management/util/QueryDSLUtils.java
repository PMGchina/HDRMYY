...
public class QueryDSLUtils {
	...
	public static <S> JPAUpdateClause newUpdate(@NonNull EntityManager entityManager, @NonNull EntityPathBase<?> entityPath, @NonNull Path<S> path, S value, Predicate predicate) {
		...
		return bindPredicateThenReturnClause(predicate, update);
	}
	...
	public static <S> JPAUpdateClause newUpdate(@NonNull EntityManager entityManager, @NonNull EntityPathBase<?> entityPath, @NonNull Path<S> path, @NonNull Expression<S> expression) {
		return newUpdate(entityManager, entityPath).set(path, expression);
	}
	
	public static <S> JPAUpdateClause newUpdate(@NonNull EntityManager entityManager, @NonNull EntityPathBase<?> entityPath, @NonNull Path<S> path, @NonNull Expression<S> expression, Predicate predicate) {
		JPAUpdateClause update = newUpdate(entityManager, entityPath, path, expression);
		return bindPredicateThenReturnClause(predicate, update);
	}
	...
	public static <S> long doUpdate(@NonNull EntityManager entityManager, @NonNull EntityPathBase<?> entityPath, @NonNull Path<S> path, @NonNull Expression<S> expression) {
		return newUpdate(entityManager, entityPath, path, expression).execute();
	}
	
	public static <S> long doUpdate(@NonNull EntityManager entityManager, @NonNull EntityPathBase<?> entityPath, @NonNull Path<S> path, @NonNull Expression<S> expression, Predicate predicate) {
		return newUpdate(entityManager, entityPath, path, expression, predicate).execute();
	}
	...
	public static JPAUpdateClause bindPredicateThenReturnClause(Predicate predicate, JPAUpdateClause update) {
