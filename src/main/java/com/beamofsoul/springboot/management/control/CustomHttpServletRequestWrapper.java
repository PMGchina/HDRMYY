package com.beamofsoul.springboot.management.control;
...
public class CustomHttpServletRequestWrapper extends HttpServletRequestWrapper {
	...
	public CustomHttpServletRequestWrapper(HttpServletRequest request) {
		super(request);
		requestBody = HttpServletRequestUtils.getRequestBody(request).getBytes(HttpServletRequestUtils.DEFAULT_CHARSET);
	}
	...
	public void setRequestBody(String requestBody) {
		this.requestBody = requestBody.getBytes(HttpServletRequestUtils.DEFAULT_CHARSET);
	}
