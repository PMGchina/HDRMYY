...
var columnNames = ['ID','标题','就诊卡号码','可用状态','创建日期','最后修改日期','操作'];
//tableContainer中表格每列对应的业务模型实体类的属性名
var attributeNames = ['id','title','medicalCard','available','createDate','modifyDate','operation'];
...
var validateRules = [
	...
	{name: 'content', maxLength: 512},
];
/*****************************************************************************************
 *************************************** LIST PAGE ***************************************
 *****************************************************************************************/
loadPageableDataUrl = 'messageBoardsByPage'; //加载分页数据对应的后台请求映射URL
...
documentReady = function() { //pagination-utils.js 绑定所有表单单击(目的为提交表单)事件
	...
	initCKEditor(['add_content', 'update_content', 'copy_content']);
};
