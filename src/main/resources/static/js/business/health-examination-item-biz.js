moduleName = 'healthExaminationItem';
...
var columnNames = ['ID','项目名','单价','可用状态','操作'];
//tableContainer中表格每列对应的业务模型实体类的属性名
var attributeNames = ['id','name','price','available','operation'];
...
var validateRules = [
	...
	{name: 'price', required: true, greatEqual: '0.00'},
	{name: 'description', maxLength: 512}
];
/*****************************************************************************************
 *************************************** LIST PAGE ***************************************
 *****************************************************************************************/
loadPageableDataUrl = 'healthExaminationItemsByPage'; //加载分页数据对应的后台请求映射URL
