...
var columnNames = ['ID','事件标题','可用状态','创建日期','最后修改日期','操作'];
//tableContainer中表格每列对应的业务模型实体类的属性名
var attributeNames = ['id','title','available','createDate','modifyDate','operation'];
 ...
 *************************************** LIST PAGE ***************************************
 *****************************************************************************************/
loadPageableDataUrl = 'hospitalEventsByPage'; //加载分页数据对应的后台请求映射URL
